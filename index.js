...
const donet = "https://github.com/Iantezz/DREADEDGPT-AI";
const owner = ["254701830680"]; // This will send a notification once the bot reconnects
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Follow me on GitHub as Iantezz", "red"));
